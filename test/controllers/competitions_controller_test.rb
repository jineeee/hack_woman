...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { category: @competition.category, content: @competition.content, day: @competition.day }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { category: @competition.category, content: @competition.content, day: @competition.day }
    assert_redirected_to competition_path(assigns(:competition))
  end
